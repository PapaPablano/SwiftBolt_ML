...
class PortfolioManager:
    ...
    def suggest_delta_hedge(self, target_delta: float = 0, underlying_price: float = 100) -> Dict:
    ...
    def get_portfolio_summary(self) -> Dict:
        ...
        if positions_df.empty:
            return {"num_positions": 0, "total_market_value": 0, "total_pnl": 0, "greeks": greeks}
        ...
        return {
            ...
            "cash": self.cash,
            "greeks": greeks,
            "largest_position": positions_df.loc[
                positions_df["market_value"].abs().idxmax(), "symbol"
            ],
            "most_profitable": (
                positions_df.loc[positions_df["pnl"].idxmax(), "symbol"]
