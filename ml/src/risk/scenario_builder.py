...
class ScenarioBuilder:
    ...
    def add_market_shock(self, symbol: str, shock_pct: float) -> "ScenarioBuilder":
    ...
    def add_broad_market_shock(
        self, shock_pct: float, indices: Optional[List[str]] = None
    ) -> "ScenarioBuilder":
    ...
    def add_volatility_spike(self, multiplier: float) -> "ScenarioBuilder":
    ...
    def add_correlation_shift(self, adjustment: float) -> "ScenarioBuilder":
    ...
    def create_recession_scenario() -> Scenario:
        ...
        builder = ScenarioBuilder()
        return (
            builder.add_broad_market_shock(-0.25)
    ...
    def create_inflation_shock_scenario() -> Scenario:
        ...
        builder = ScenarioBuilder()
        return (
            builder.add_broad_market_shock(-0.15)
    ...
    def create_liquidity_crisis_scenario() -> Scenario:
        ...
        builder = ScenarioBuilder()
        return (
            builder.add_broad_market_shock(-0.30)
    ...
    def create_geopolitical_crisis_scenario() -> Scenario:
        ...
        builder = ScenarioBuilder()
        return (
            builder.add_broad_market_shock(-0.20)
...
if __name__ == "__main__":
    ...
    builder = ScenarioBuilder()
    scenario1 = (
        builder.add_market_shock("SPY", -0.15)
    ...
    for scenario in all_scenarios:
        ...
        print(
            f"{scenario.name:<25} {equity_shock*100:<15.1f}% {vol_mult:<12.1f}x {corr_adj*100:<12.1f}%"
        )
