...
Key concepts:
- Intrinsic value: The in-the-money portion (stock price - strike for calls)
- Extrinsic value: Time value + volatility premium
- Time value rich options decay faster but offer more leverage
- Intrinsic rich options behave more like stock
"""
