...
class WandBTracker:
    ...
    def __init__(
        self, project: str = "swiftbolt-ml", entity: Optional[str] = None, enabled: bool = True
    ):
    ...
    def save_model(self, model: Any, filename: str, metadata: Optional[Dict] = None):
        ...
        # Log as artifact
        self.log_artifact(
            str(model_path), name=f"model-{wandb.run.id}", type="model", metadata=metadata
        )
    ...
    def watch_model(self, model: Any, log: str = "all", log_freq: int = 100):
...
class WandBSweepManager:
    ...
    def __init__(self, project: str = "swiftbolt-ml", entity: Optional[str] = None):
    ...
    def create_sweep(self, sweep_config: Dict, sweep_name: Optional[str] = None) -> str:
    ...
    def run_sweep_agent(self, sweep_id: str, train_function: callable, count: Optional[int] = None):
        """Run sweep agent.
        ...
        """
        wandb.agent(
            sweep_id, function=train_function, count=count, project=self.project, entity=self.entity
        )
