...
class TestGreeksValidator:
    ...
    def atm_call_greeks(self):
        ...
        return {"delta": 0.5234, "gamma": 0.0312, "theta": -0.0456, "vega": 0.1845, "rho": 0.0234}

    @pytest.fixture
    def atm_put_greeks(self):
        """Sample Greeks for ATM put option."""
        return {"delta": -0.4766, "gamma": 0.0312, "theta": -0.0406, "vega": 0.1845, "rho": -0.0766}
    ...
    def test_mispricing_score_calculation(self, validator):
        ...
        bad_greeks = {"delta": 0.90, "gamma": 0.10, "theta": 0.05, "vega": 0.30, "rho": 0.10}
...
if __name__ == "__main__":
    ...
    pytest.main(
        [__file__, "-v", "--cov=src/validation/greeks_validator", "--cov-report=term-missing"]
    )
