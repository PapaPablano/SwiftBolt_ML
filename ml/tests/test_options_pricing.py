...
class TestBlackScholesModel:
    ...
    def test_greeks_call_atm(self, bs_model):
        ...
        pricing = bs_model.calculate_greeks(S=100, K=100, T=1.0, sigma=0.20, option_type="call")
    ...
    def test_greeks_put_atm(self, bs_model):
        ...
        pricing = bs_model.calculate_greeks(S=100, K=100, T=1.0, sigma=0.20, option_type="put")
    ...
    def test_greeks_at_expiration(self, bs_model):
        ...
        # ITM call
        pricing = bs_model.calculate_greeks(S=110, K=100, T=0, sigma=0.20, option_type="call")
        ...
        # OTM call
        pricing = bs_model.calculate_greeks(S=90, K=100, T=0, sigma=0.20, option_type="call")
    ...
    def test_delta_range(self, bs_model):
        ...
        for case in test_cases:
            pricing = bs_model.calculate_greeks(
                S=case["S"], K=case["K"], T=case["T"], sigma=case["sigma"], option_type=case["type"]
            )
    ...
    def test_implied_volatility_basic(self, bs_model):
        ...
        calculated_iv = bs_model.calculate_implied_volatility(
            market_price=market_price, S=100, K=100, T=1.0, option_type="call"
        )
    ...
    def test_implied_volatility_put(self, bs_model):
        ...
        calculated_iv = bs_model.calculate_implied_volatility(
            market_price=market_price, S=100, K=100, T=1.0, option_type="put"
        )
    ...
    def test_implied_volatility_itm(self, bs_model):
        ...
        calculated_iv = bs_model.calculate_implied_volatility(
            market_price=market_price, S=110, K=100, T=0.5, option_type="call"
        )
    ...
    def test_implied_volatility_invalid_inputs(self, bs_model):
        ...
        with pytest.raises(ValueError, match="must be positive"):
            bs_model.calculate_implied_volatility(
                market_price=-5.0, S=100, K=100, T=1.0, option_type="call"
            )

        # Call price > stock price
        with pytest.raises(ValueError, match="cannot exceed stock price"):
            bs_model.calculate_implied_volatility(
                market_price=110.0, S=100, K=100, T=1.0, option_type="call"
            )

        # Put price > strike
        with pytest.raises(ValueError, match="cannot exceed strike"):
            bs_model.calculate_implied_volatility(
                market_price=110.0, S=100, K=100, T=1.0, option_type="put"
            )
    ...
    def test_implied_volatility_expired(self, bs_model):
        ...
        iv = bs_model.calculate_implied_volatility(
            market_price=10.0, S=110, K=100, T=0, option_type="call"
        )
    ...
    def test_volatility_smile(self, bs_model):
        ...
        for K in strikes:
            ...
            iv = bs_model.calculate_implied_volatility(
                market_price=market_price, S=S, K=K, T=T, option_type="call"
            )
            ivs.append(iv)
