...
class TestBacktestFramework:
    ...
    def test_run_backtest_basic(self, sample_ohlcv_data, simple_signal_generator):
    ...
    def test_run_backtest_with_date_filter(self, sample_ohlcv_data, simple_signal_generator):
    ...
    def test_equity_curve_generated(self, sample_ohlcv_data, simple_signal_generator):
    ...
    def test_trades_recorded(self, sample_ohlcv_data, simple_signal_generator):
    ...
    def test_walk_forward_backtest(self, sample_ohlcv_data):
