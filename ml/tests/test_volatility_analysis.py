...
class TestVolatilityAnalyzer:
    ...
    def test_expected_move_basic(self, analyzer):
        ...
        move = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.25, days_to_expiration=30
        )
    ...
    def test_expected_move_scaling(self, analyzer):
        ...
        double_vol_move = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.50, days_to_expiration=30
        )
        ...
        double_price_move = analyzer.calculate_expected_move(
            stock_price=200, implied_vol=0.25, days_to_expiration=30
        )
    ...
    def test_expected_move_time_decay(self, analyzer):
        ...
        move_15d = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.25, days_to_expiration=15
        )

        move_7d = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.25, days_to_expiration=7
        )
    ...
    def test_expected_move_at_expiration(self, analyzer):
        ...
        move = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.25, days_to_expiration=0
        )
    ...
    def test_identify_vol_regime_prefers_percentile(self, analyzer):
        ...
        regime = analyzer.identify_vol_regime(iv_rank=10, iv_percentile=80)  # Low  # High
...
class TestEdgeCases:
    ...
    def test_very_high_volatility(self, analyzer):
        ...
        # 200% annualized vol
        move = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=2.0, days_to_expiration=30
        )
    ...
    def test_very_low_volatility(self, analyzer):
        ...
        # 1% annualized vol
        move = analyzer.calculate_expected_move(
            stock_price=100, implied_vol=0.01, days_to_expiration=30
        )
...
if __name__ == "__main__":
    ...
    pytest.main(
        [__file__, "-v", "--cov=src/features/volatility_analysis", "--cov-report=term-missing"]
    )
