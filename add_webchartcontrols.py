...
\t\t{build_id} /* WebChartControlsView.swift in Sources */ = {{isa = PBXBuildFile; fileRef = {file_id} /* WebChartControlsView.swift */; }};'''
    ...
    pbx_file_insert = f'''\\1
\t\t{file_id} /* WebChartControlsView.swift */ = {{isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = WebChartControlsView.swift; sourceTree = "<group>"; }};'''
    
    content = re.sub(pbx_file_pattern, pbx_file_insert, content)
    
    # Add to Views group (find an existing view file and add after it)
    views_pattern = r'(/\* Views \*/[^=]+=\s*{[^}]*children = \([^)]*)(WebChartView\.swift[^;]*;)'
    views_insert = f'''\\1\\2
\t\t\t\t{file_id} /* WebChartControlsView.swift */,'''
    ...
    sources_pattern = r'(/\* Sources \*/[^=]+=\s*{[^}]*files = \([^)]*)(WebChartView\.swift in Sources[^;]*;)'
