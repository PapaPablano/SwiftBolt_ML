...
# Run from root: resolve src to ml/src
...
def evaluate_stock_in_regime(
    ...
    try:
        ...
        for i in range(n_windows):
            ...
            window_accuracies.append((y_pred == y_test_bin).mean())
...
def quick_test_single_stock(symbol: str, regime_name: str = 'crash_2022'):
    ...
    if regime_name not in REGIMES:
        print(f"Unknown regime: {regime_name!r}. Valid: {list(REGIMES.keys())}")
        return
    print(f"\n{'='*80}")
