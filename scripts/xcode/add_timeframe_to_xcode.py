...
def add_timeframe_to_xcode(project_path):
    ...
    pbx_build_insert = (
        "\\1\n"
        f"\t\t{timeframe_build_id} /* Timeframe.swift in Sources */ = "
        "{isa = PBXBuildFile; fileRef = "
        f"{timeframe_file_id} /* Timeframe.swift */; }};"
    )
    ...
    pbx_file_insert = (
        ...
        "path = Timeframe.swift; sourceTree = \"<group>\"; }};"
    )
