...
file_ref = (
    f'\t\t{file_ref_id} /* ChartDataV2Response.swift */ = {{isa = '
    'PBXFileReference; lastKnownFileType = sourcecode.swift; '
    'path = ChartDataV2Response.swift; sourceTree = "<group>"; }};'
)

# Find where to insert (after ChartResponse.swift)
chart_response_pattern = (
    r'(A2000010233456780000010 /\* ChartResponse\.swift \*/ = '
...
# 2. Add PBXBuildFile
build_file = (
    f'\t\t{build_file_id} /* ChartDataV2Response.swift in Sources */ = '
...
build_file_pattern = (
    r'(A1000010233456780000010 /\* ChartResponse\.swift in Sources '
    r'\*/ = \{isa = PBXBuildFile;[^\}]+\};)'
)
content = re.sub(
    build_file_pattern,
