        ...
        VStack(spacing: 12) {
            ...
            VStack(spacing: 8) {
                ...
                HStack {
                    ...
                    Picker("", selection: deferredBinding(get: { rankerViewModel.rankingMode }, set: { rankerViewModel.rankingMode = $0 })) {
                ...
                HStack(spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Slider(value: deferredBinding(get: { rankerViewModel.minScore }, set: { rankerViewModel.minScore = $0 }), in: 0...1, step: 0.05)
                            .tint(.purple)
                    }
                }
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    HStack(spacing: 8) {
                        TextField("Min $", text: deferredBinding(get: { rankerViewModel.minPriceInput }, set: { rankerViewModel.minPriceInput = $0 }))
                        ...
                        TextField("Max $", text: deferredBinding(get: { rankerViewModel.maxPriceInput }, set: { rankerViewModel.maxPriceInput = $0 }))
                            .textFieldStyle(.roundedBorder)
                            .frame(width: 80)
                    }
                }
