...
struct OHLCBar: Codable, Identifiable, Equatable {
    ...
    init(ts: Date, open: Double, high: Double, low: Double, close: Double, volume: Double, isForecast: Bool = false, upperBand: Double? = nil, lowerBand: Double? = nil, confidenceScore: Double? = nil) {
        self.ts = ts
        self.open = open
        self.high = high
        self.low = low
