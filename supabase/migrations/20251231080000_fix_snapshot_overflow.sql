-- Migration: Fix numeric overflow in capture_options_snapshot
-- Clamps extreme values to fit within column precision limits
...
COMMENT ON FUNCTION capture_options_snapshot IS 'Captures current options_ranks data into price history for a given symbol, with value clamping to prevent numeric overflow';
