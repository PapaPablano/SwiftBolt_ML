...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const stocksUrl = "https://data.alpaca.markets/v2/stocks/AAPL/bars?start=2024-01-01&end=2024-01-05&limit=5";
    ...
    const futuresUrl = "https://data.alpaca.markets/v2/futures/CME:GC/bars?start=2024-01-01&end=2024-01-05&limit=5";
