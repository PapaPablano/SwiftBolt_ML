...
serve(async (req: Request): Promise<Response> => {
  try {
    ...
    if (rootsError) {
      return corsResponse(
        { error: "Failed to insert roots", details: rootsError.message },
        500,
        null,
      );
    }
