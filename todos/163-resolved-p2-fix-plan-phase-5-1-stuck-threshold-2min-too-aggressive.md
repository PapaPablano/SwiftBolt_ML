...
- [x] Stuck position threshold updated to 5 minutes (300,000ms) OR made configurable
- [x] Plan references institutional learnings document for the 5-minute recommendation
- [x] Minimum threshold bounded to prevent overly aggressive values being set via env var
