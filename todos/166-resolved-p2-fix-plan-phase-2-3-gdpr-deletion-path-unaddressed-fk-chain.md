...
- [x] Phase 2.3 migration comment explains the intentional RESTRICT FK chain
- [x] Manual deletion order documented (trades → positions → user)
- [x] Plan acknowledges there is no automated GDPR purge path (intentional for financial records)
