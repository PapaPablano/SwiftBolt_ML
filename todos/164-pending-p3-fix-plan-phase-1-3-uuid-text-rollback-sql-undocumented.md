...
- [ ] Plan documents that UUID→TEXT is effectively irreversible once raw symbol strings are written
- [ ] Rollback SQL provided with caveat that it fails after non-UUID inserts
- [ ] Deployment checklist updated to note position count before/after migration
