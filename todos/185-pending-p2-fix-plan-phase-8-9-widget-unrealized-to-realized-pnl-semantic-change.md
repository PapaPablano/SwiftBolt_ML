...
- [ ] Plan explicitly documents the semantic change: Phase 8.9 replaces unrealized P&L display with realized P&L
- [ ] Widget label updated to distinguish realized P&L from unrealized P&L
- [ ] Either: both values shown, OR clear labeling, OR documented rationale for showing only realized
- [ ] UX regression acknowledged: users with open positions and no closed trades should not see a confusingly empty or $0 P&L figure
