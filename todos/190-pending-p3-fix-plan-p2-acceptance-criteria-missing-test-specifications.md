...
- [ ] Plan includes test specifications for SL/TP fill price calculation verification
- [ ] Plan includes test specifications for FK RESTRICT verification (SQL DELETE test)
- [ ] Plan includes test specifications for CHECK constraint verification (bad-data INSERT test)
- [ ] Verification queries added to `docs/DEPLOYMENT_VERIFICATION_PR28_LIVE_TRADING.md`
