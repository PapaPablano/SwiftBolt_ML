...
- [x] Plan's Phase 8.2 description corrected to reflect that `action` is not required today
- [x] Phase 8.2 characterized as defensive improvement, not bug fix
- [x] Code change (add `action: "execute"`) still included — just with accurate rationale
