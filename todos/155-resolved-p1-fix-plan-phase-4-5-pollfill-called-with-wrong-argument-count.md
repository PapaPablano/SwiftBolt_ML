...
- [x] `pollOrderFill` call in Phase 4.5 matches the actual function signature
- [x] If timeout parameter is added, it is optional with a backward-compatible default
- [x] The plan documents what happens when close fill poll times out (fallback to current_price, reconciliation needed)
