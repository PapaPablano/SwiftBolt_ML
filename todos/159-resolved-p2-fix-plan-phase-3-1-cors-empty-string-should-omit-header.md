...
- [x] Phase 3.1 uses conditional header omission (not empty string)
- [x] Plan includes caller audit step before deployment
- [x] Deployment checklist includes `ALLOWED_ORIGINS` verification
