...
- [ ] `SET search_path = public, pg_temp` added to `increment_rate_limit` definition in Phase 2.2
- [ ] Any other `SECURITY DEFINER` functions in the migration also audited for this guard
