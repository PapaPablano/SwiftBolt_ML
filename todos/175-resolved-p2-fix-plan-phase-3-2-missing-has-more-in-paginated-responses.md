...
- [x] `has_more: boolean` added to positions endpoint response
- [x] `has_more: boolean` added to trades endpoint response
- [x] `has_more: boolean` added to summary endpoint response (if paginated)
- [x] `has_more` correctly evaluates to `false` on the final page (when `count` rows have been returned)
