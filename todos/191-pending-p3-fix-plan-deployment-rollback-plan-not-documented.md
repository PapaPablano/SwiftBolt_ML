...
- [ ] Plan includes a "Rollback Plan" table for each migration step's failure scenario
- [ ] Phase 1.3 one-way door documented (consistent with todo #164)
- [ ] Each partial-deploy state is assessed as safe or unsafe to continue operating in
- [ ] If any state is unsafe, a recovery procedure is documented
