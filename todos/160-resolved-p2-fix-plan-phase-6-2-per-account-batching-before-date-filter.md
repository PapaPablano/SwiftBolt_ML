...
- [x] Plan documents the dependency: 7.4 must precede 6.2
- [x] Implementation sequence updated so date filter is in place before per-account batching goes live
- [x] OR both phases deployed atomically in the same deploy
