...
- [ ] Phase 4.2 code snippet updated in the plan so cancelOrder is called exactly once per error path
- [ ] Secondary error handling added if cancelOrder itself throws
- [ ] 23505 duplicate case still calls cancelOrder (existing position wins)
- [ ] Non-23505 errors still propagate after cancel
